...
class BookCarScreen extends StatefulWidget {
  ...
  BookCarScreen({Key key, this.car}) : super(key: key);
...
class _BookCarScreenState extends State<BookCarScreen> {
  ...
  List<Widget> buildPageIndicator(int imagesLength) {
    List<Widget> list = [];
  ...
  Widget build(BuildContext context) {
    final BookCarScreen carArg = ModalRoute.of(context).settings.arguments;
                      ...
                      Expanded(
                        child: Container(
                          child: PageView(
                            ...
                            children: carArg.car.images.map((path) {
                              return Container(
                                padding: EdgeInsets.symmetric(horizontal: 16),
                                child: Image.asset(
                                  path,
